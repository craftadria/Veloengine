...
Public Class Form1
    ...
    Function CompileAudio()
        Shell("cmd.exe /k" & "Assetbuilder " & InputBox("Nombre del archivo a compilar?") & "< iefmeta.txt")
        'Shell("cmd.exe /k" & "ffmpeg -i" & InputBox("Archivo a encolar?") & "< iefmeta.txt")
    End Function
    ...
    Private Sub BuscarToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles BuscarToolStripMenuItem.Click
        ...
        Dim ofrmBuscar As New TextSearch()
    ...
    Private Sub AercaDeToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles AercaDeToolStripMenuItem.Click
        Dim AboutTimetrollergames As New Veloengine.AboutBox1
        AboutTimetrollergames.ShowDialog()
    End Sub

    Private Sub DonarToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles DonarToolStripMenuItem.Click
        Shell("cmd.exe /c start http://bitigee.com/28oE")
    End Sub
    ...
    Private Sub dlgfuente_Apply(sender As Object, e As EventArgs) Handles dlgfuente.Apply
        Me.AplicarFuente()
    End Sub

    Private Sub BuildMeToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles BuildMeToolStripMenuItem.Click
        Dim TextEditor As String = System.Windows.Forms.Application.StartupPath() + "/Freebasic editor.exe"
        Shell(TextEditor)
    End Sub
End Class
